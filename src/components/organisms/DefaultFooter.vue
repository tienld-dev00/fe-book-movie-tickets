<template>
    <div class="flex flex-col mt-10">
        <div class="flex flex-col bg-colors_footer-menu-25 h-32 justify-center">
            <div class="flex justify-center mb-3">
                <button class="p-3">
                    <img src="/src/assets/img/facebook.png">
                </button>
                <button class="p-3">
                    <img src="/src/assets/img/google.png">
                </button>
                <button class="p-3">
                ...
                <div class="lg:w-1/2">
                    <div class="flex flex-col h-full justify-center">
                        ...
                        <span class="font-normal text-white text-xs md:text-sm lg:text-base text-center lg:text-start">
                            ...
                            Nang City, <br>
                            Business registration address: 685 Tran Cao Van, Da Nang City, Viet Nam.<br>
                            Holine: 1234567890 <br>
