            ...
            <form class="ml-5 mr-5">
                <div class="mt-4 mb-4 text-center">
                    <div class="relative inline-block">
                        <img src="/src/assets/img/logo.png" alt="Avatar" class="w-32 h-32 rounded-full object-cover">
                        <button class="absolute bottom-0 right-0 p-1 bg-white rounded-full">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" class="w-full mt-2 p-2 border rounded">
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" class="w-full mt-2 p-2 border rounded">
                </div>
                <div class="text-center mt-5">
                    <button class=" bg-colers_text-700 text-white px-4 py-2 rounded hover:bg-blue-600">Save</button>
                </div>
            </form>
        </div>
    </div>
