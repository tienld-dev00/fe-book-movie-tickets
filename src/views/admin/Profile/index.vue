<template>
    <div class="md:bg-white md:shadow-lg md:rounded-lg">
        <div class="flex justify-center border-b">
            <button @click="toggleTab('profile')" :class="{ 'border-b-2 border-orange-500': currentTab === 'profile' }"
...
import { changePassword, getUserProfile, updateProfile } from '@/api/modules/auth/index';
...
const handleChangePassword = async (values) => {
    try {
        ...
        passwordChange.new_password_confirmation = '';
    } catch (error: any) {
